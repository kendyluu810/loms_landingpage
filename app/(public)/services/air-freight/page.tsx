  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-row justify-center space-x-8  mt-28">
        ...
        >
          <h2 className="text-5xl font-bold text-green-500">Air Freight</h2>
      ...
      <motion.div
        ...
        className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mt-10 mb-5"
      >
        {cards.map((item, idx) => (
          <motion.div
            key={idx}
            ...
            className="bg-green-600 text-white rounded-lg p-8 flex flex-col items-center justify-center text-center shadow-md cursor-pointer"
          >
            <Image
              src={item.icon}
              alt={item.text}
