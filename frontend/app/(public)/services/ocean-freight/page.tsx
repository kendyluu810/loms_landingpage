...
export default function OceanFreightPage() {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 w-full max-w-7xl px-6">
        {/* left */}
        <motion.div
        ...
        <motion.div
          ...
          className="w-full aspect-video rounded-xl shadow-lg overflow-hidden relative"
        >
          <Image
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-l border-r rounded-t-lg overflow-hidden">
          <div className="bg-green-600 text-white p-6 md:p-8 flex flex-col justify-center">
        ...
        {/* Hàng dưới: 4 benefit */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 border rounded-b-lg overflow-hidden mb-6">
          {benefits.slice(2).map((item, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center justify-center p-6 border-t md:border-t-0 md:border-l"
            >
              <Image
                src={item.icon}
                alt={item.text}
